...
$(function() {
    ...
    editor.removeLineError = function() {
        ...
        for (var i = 0; i < count; i++) {
            ...
            if (lineInfo.bgClass && (lineInfo.bgClass.indexOf("line-error-MoonLight") > -1 || lineInfo.bgClass.indexOf("line-error-DarkShadow") > -1)) {
    ...
    editor.removeLineRunning = function() {
        ...
        for (var i = 0; i < count; i++) {
            var lineInfo = editor.lineInfo(i);
            if (lineInfo.bgClass && (lineInfo.bgClass.indexOf("line-running-MoonLight") > -1 || lineInfo.bgClass.indexOf("line-running-DarkShadow") > -1)) {
        ...
        if (e.target) {
            ...
            if (target.attr("class") === "imgClass") {
                ...
                for (var i = 0; i < imgList.length; i++) {
                    ...
                    if (pos.from.line == lineCh.line && pos.from.ch <= lineCh.ch && pos.to.line == lineCh.line && pos.to.ch >= lineCh.ch) {
