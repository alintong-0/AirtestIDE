...
(function(mod) {
    ...
    function SearchBox(cm) {
        ...
        function initElements(el) {
            ...
            self.changeMode             = el.querySelector('.ace_mode_change');
        }
        ...
        function init() {
            ...
            self.changeMode.addEventListener('click', function() {
                self.isReplace = !self.isReplace;
                self.show(null, self.isReplace);
            })
        }
            ...
            var style   = document.createElement('style'),
                css     = [
                    ...
                    '.ace_mode_change {',
                        ...
                        'height: 0;',
                    '}',
                    '.ace_mode_change::after {',
                        'content:"";',
                        'position: absolute;',
                        'width: 0;',
                        'height: 0;',
                    '}',
                    '.ace_mode_change.left {',
                        'top: 6px;',
                        'left: 6px;',
                    ...
                    '.ace_mode_change.left::after {',
                        ...
                        'border-bottom: 8px solid transparent;',
                    '}',
                    '.ace_mode_change.left:hover {',
                        'border-left-color: white;',
                    '}',
                    '.ace_mode_change.down {',
                        'top: 11px;',
                        'left: 4px;',
            ...
            var elSearch,
                ...
                html    = [
                    '<div class="ace_search right">',
                        '<div class="ace_mode_change left"></div>',
